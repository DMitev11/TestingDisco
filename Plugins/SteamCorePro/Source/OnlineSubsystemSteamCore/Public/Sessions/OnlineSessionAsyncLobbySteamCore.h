...
{
public:
	FOnlineAsyncTaskSteamCoreFindLobbiesForInviteSession(class FOnlineSubsystemSteamCore* InSubsystem, const FUniqueNetIdSteam& InLobbyId, const TSharedPtr<FOnlineSessionSearch>& InSearchSettings, int32 InLocalUserNum, const FOnAsyncFindLobbyCompleteWithNetId& InOnFindLobbyCompleteDelegates)
		: FOnlineAsyncTaskSteamCoreFindLobbiesBase(InSubsystem, InSearchSettings),
